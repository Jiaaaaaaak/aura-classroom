...
export default function History() {
  ...
  // Mock history data
  const historyItems = [
    { id: 1, date: "2026-02-01", topic: "考場失利後的自責" },
    { id: 2, date: "2026-01-30", topic: "分組被落單的窘迫" },
    { id: 3, date: "2026-01-28", topic: "被當眾誤解的憤怒" },
    { id: 4, date: "2026-01-25", topic: "好朋友吵架的糾結" },
    { id: 5, date: "2026-01-20", topic: "面對新環境的焦慮" },
    { id: 6, date: "2026-02-10", topic: "承認作弊後的羞愧" },
  ];
